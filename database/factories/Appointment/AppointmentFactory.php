...
class AppointmentFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $date_appointment = $this->faker->dateTimeBetween("2024-01-01 00:00:00", "2024-05-15 23:59:59");
        ...
        return [
            ...
            "date_attention" => $status == 2 ? $this->faker->dateTimeBetween($date_appointment, "2024-05-15 23:59:59") : NULL,
        ];
    }
}
