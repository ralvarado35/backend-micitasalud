...
class Appointment extends Model
{
    ...
    public function scopefilterAdvance($query,$specialitie_id,$name_doctor, $name_patient, $date,$user = null){
        ...
        if($name_patient){
            $query->whereHas("patient",function($q) use($name_patient){
                $q->where("name","like","%".$name_patient."%")
                ->orWhere("surname","like","%".$name_patient."%");
            });
        }
