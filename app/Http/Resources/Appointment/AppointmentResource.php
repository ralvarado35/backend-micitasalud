        ...
        return [
            ...
            "patient" =>  $this->resource->patient ?
                [
                    ...
                    "avatar" => env("APP_URL")."storage/".$this->resource->patient->avatar,
            ...
            "consult" => $this->resource->consult,
            "date_appointment_format" => Carbon::parse($this->resource->date_appointment)->format("d-m-Y"),
