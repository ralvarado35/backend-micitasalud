...
class PatientController extends Controller
{
    ...
    public function profile($id) {
            ...
            $appointment_attentions = Appointment::where("patient_id",$id)->where("status",2)->get();
            ...
            $data_patient = [                
                ...
                "appointment_attentions" => AppointmentCollection::make($appointment_attentions),
                "appointments" => $appointments->map(function($appointment){
                    return [
                        ...
                        "appointment_attention" => $appointment->attention ? [
                            ...
                            "created_at" => $appointment->attention->created_at->format("d-m-Y h:i A"),
                        ] : NULL,
    ...
    public function store(Request $request)
    {
        ...
        if($patient_is_valid){
            return response()->json([
                "message" => 403,
                "message_text" => "EL PACIENTE CON NO. DOCUMENTO YA EXISTE"
            ]);
        }
